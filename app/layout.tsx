...
export const metadata: Metadata = {
  ...
  description:
    "Shop floor board for Neighborhood Golf Carts in Covington, LA. Board row number, Housecall Pro job number, customer, primary tech, Jobs pipeline status, next step, and Timeframe date.",
};
